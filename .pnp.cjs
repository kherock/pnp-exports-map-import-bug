...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      {
        "name": "pnp-exports-map-import-bug",
        "reference": "workspace:."
      },
      {
        "name": "my-package",
        "reference": "workspace:my-package"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)",
    "fallbackExclusionList": [
      ["my-package", ["workspace:my-package"]],
      ["pnp-exports-map-import-bug", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
